                    ...
                    <div class="modal fade" id="add-bot-btn" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-xl">
                            ...
                            <div class="modal-body">
                                <form>
                                    <div class="mb-3">
                                        <label for="add-bot-btn" class="form-label">名称</label>
                                        <input v-model="botadd.title" type="text" class="form-control" id="add-bot-btn" placeholder="请输入Bot名称">
                                    </div>
                                    <div class="mb-3">
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            <tr v-for="bot in bots" :key="bot.id">
                                ...
                                <td>
                                    <button type="button" class="btn btn-secondary" style="margin-right: 12px;" data-bs-toggle="modal" :data-bs-target="'#updata-bot-' + bot.id">修改</button>
                                    <button type="button" class="btn btn-danger" @click="remove_bot(bot)">删除</button>

                                    <!-- Modal -->
                                    <div class="modal fade" :id="'updata-bot-' + bot.id" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-xl">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                            ...
                                            <div class="modal-body">
                                                <form>
                                                    <div class="mb-3">
                                                        <label for="add-bot-btn" class="form-label">名称</label>
                                                        <input v-model="bot.title" type="text" class="form-control" id="add-bot-btn" placeholder="请输入Bot名称">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="add-bot-description" class="form-label">简介</label>
...
export default {
    ...
    setup() {
        ...
        const add_bot = () => {
            ...
            $.ajax({
                    url: "https://app5749.acapp.acwing.com.cn/api/user/bot/add/",
                    type: "post",
                    headers: {
                        Authorization: "Bearer " + store.state.user.token,
                    },
        ...
        const update_bot = (bot) => {
            bot.error_message = "",
            $.ajax({
                    url: "https://app5749.acapp.acwing.com.cn/api/user/bot/update/",
                    type: "post",
                    headers: {
                        Authorization: "Bearer " + store.state.user.token,
                    },
        ...
        const remove_bot = (bot) => {
            $.ajax({
                    url: "https://app5749.acapp.acwing.com.cn/api/user/bot/remove/",
                    type: "post",
                    headers: {
                        Authorization: "Bearer " + store.state.user.token,
                    },
